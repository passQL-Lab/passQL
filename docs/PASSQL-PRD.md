...
| 유사 문제 추천 | 임베딩(qwen3-embedding:4b) 기반 유사 문제 추천 |
...
- 저장 시 `body_md`를 qwen3-embedding:4b로 임베딩 → Qdrant upsert
...
| 임베딩 | Ollama `qwen3-embedding:4b` (2560-dim) | 유사 문제 검색 |
