...
export default function Stats3DChart({
  categories,
  onCategoryClick,
}: Stats3DChartProps) {
  ...
  useEffect(() => {
    ...
    const onMouseMove = (e: MouseEvent) => {
      ...
      if (
        hoveredBar &&
        (!intersects.length || intersects[0].object !== hoveredBar)
      ) {
        (hoveredBar.material as THREE.MeshStandardMaterial).emissiveIntensity =
          0.1;
