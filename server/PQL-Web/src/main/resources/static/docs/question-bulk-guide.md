...
- AI가 answerSql 실행 결과와 일치하는 선택지 1개를 정답으로 판별하고 나머지 3개는 오답을 자동 생성한다
...
| `schemaDisplay` | 선택 | 화면 표시용 스키마 요약. CONCEPT_ONLY면 null |
