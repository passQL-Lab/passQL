...
CREATE INDEX IF NOT EXISTS idx_member_auth_provider ON member (auth_provider, provider_user_id);
CREATE INDEX IF NOT EXISTS idx_member_status        ON member (status);
CREATE INDEX IF NOT EXISTS idx_member_role          ON member (role);
CREATE INDEX IF NOT EXISTS idx_member_is_test       ON member (is_test_account);
