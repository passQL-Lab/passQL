...
- 파일 네이밍: `V{숫자}__{설명}.sql` (예: `V2__add_user_table.sql`)
...
| 버전 | 파일 | 내용 |
|------|------|------|
| V1 | `V1__init_schema.sql` | 초기 스키마 전체 생성 (topic, subtopic, concept_tag, concept_doc, prompt_template, app_setting, question, question_choice) |
